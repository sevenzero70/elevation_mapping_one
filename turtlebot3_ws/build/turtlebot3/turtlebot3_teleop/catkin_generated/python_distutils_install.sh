...
echo_and_run cd "/home/zero/ETH/turtlebot3_ws/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/zero/ETH/turtlebot3_ws/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/zero/ETH/turtlebot3_ws/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
