...
set(CPACK_RESOURCE_FILE_LICENSE "/home/zero/ETH/pcl/LICENSE.txt")
set(CPACK_RESOURCE_FILE_README "/home/zero/ETH/pcl/AUTHORS.txt")
...
set(CPACK_COMPONENT_PCL_PEOPLE_DEPENDS  pcl_common pcl_kdtree pcl_search pcl_sample_consensus pcl_filters pcl_io pcl_visualization pcl_geometry pcl_segmentation pcl_octree)
...
if((WIN32 OR UNIX) AND (CPACK_GENERATOR STREQUAL "NSIS"))
    ...
    set(CPACK_NSIS_MUI_ICON "/home/zero/ETH/pcl/cmake/images/pcl.ico")
    set(CPACK_NSIS_MUI_UNIICON "/home/zero/ETH/pcl/cmake/images/pcl.ico")
    ...
    if(WIN32 AND NOT UNIX)
      ...
      set(CPACK_PACKAGE_ICON "/home/zero/ETH/pcl/cmake/images\\\\pcl_horz_large_pos.bmp")
    else()
      set(CPACK_PACKAGE_ICON "/home/zero/ETH/pcl/cmake/images/pcl_horz_large_pos.bmp")
    endif()
endif()
